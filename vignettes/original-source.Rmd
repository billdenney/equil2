...
Below are the original Visual Basic source code used for the translation to R.  These are included to allow users to inspect the fidelity of the code translation.
...
The code below is the basis of the `supersat()` function.
